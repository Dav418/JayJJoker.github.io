function conversionTable(tagID,from,to){
    ...
    if(!document.getElementById("C").checked && !document.getElementById("F").checked){ //start error checking
        ...
        alert("Cant leave both text boxes empty!");}
            ...
            if(document.getElementById("C").checked){                   //depending on what the user selected from radio buttons
            ...
            for (var i=from;i != to;) {                             //loop to make table
                ...
                if (i%2===1) {
                    ...
                    else {                                          //to make different rows have different col
                    ...
                    if(document.getElementById("C").checked){       // again depends on what the user has clicked
